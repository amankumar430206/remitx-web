...
import { useFeeConfigs, useCreateFeeConfig, useDeleteFeeConfig } from '@/hooks/useAdmin'
import type { FeeConfig } from '@/api/admin'
    ...
    <>
      <ContentCard padding="none">
        ...
        {isLoading ? (
          ...
          <DataTable
            columns={feeColumns(onDelete, deleteMutation.isPending)}
            data={feeConfigs ?? []}
            getRowId={row => row.id}
